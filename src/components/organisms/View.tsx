    ...
    return (
        <>
            <div className={className}>
                ...
                <div className="hidden md:flex flex-col min-w-96 max-w-md max-h-[calc(100vh-9.4rem)] h-[calc(100vh-9.4rem)] bg-gray-50 overflow-auto border border-e-gray-200 scrollbar scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                    <ContactList show={view === Views.CONTACTS} />
                    <Favorites show={view === Views.FAVORITES} />
                </div>
            </div>
