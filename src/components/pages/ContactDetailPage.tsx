...
const ContactDetailPage = () => {
    ...
    return (
        <>
            <div className={`mx-auto ${isMobile ? '' : 'max-w-[50%] w-96'} bg-white rounded-lg`}>
                ...
                <div className={`flex justify-center items-center space-x-4 ${isMobile ? 'bg-gray-50 border border-t-gray-200 h-20' : 'mt-5'}`}>
                    <Button
